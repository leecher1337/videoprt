...
#pragma comment(linker,"/export:VideoPortSetTrappedEmulatorPorts=_VideoPortSetTrappedEmulatorPorts1@12,@93")
...
#pragma comment(linker,"/export:VideoPortMapMemory=_VideoPortMapMemory1@24,@60")
#pragma comment(linker,"/export:VideoPortUnmapMemory=_VideoPortUnmapMemory1@12,@103")
